...
CREATE TABLE `telephone` (
  ...
  PRIMARY KEY (`phone_no`,`Place_address`),
  KEY `fk_Telephone_Place_idx` (`Place_address`),
  CONSTRAINT `fk_Telephone_Place` FOREIGN KEY (`Place_address`) REFERENCES `place` (`address`) ON DELETE NO ACTION ON UPDATE NO ACTION
